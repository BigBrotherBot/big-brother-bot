...
class Test_getServerInfo(unittest.TestCase):
    ...
    def get_test_data(self, **kwargs):
        ...
        if numTeams == '4':
            return (serverName, numPlayers, maxPlayers, gamemode, level, roundsPlayed, roundsTotal, numTeams,
                    team1score, team2score, team3score, team4score, targetScore, onlineState, isRanked, hasPunkbuster,
                    hasPassword, serverUptime, roundTime, gameIpAndPort, punkBusterVersion, joinQueueEnabled, region,
                    closestPingSite, country, blazePlayerCount, blazeGameState)
        else:
            return (serverName, numPlayers, maxPlayers, gamemode, level, roundsPlayed, roundsTotal, numTeams,
                    team1score, team2score, targetScore, onlineState, isRanked, hasPunkbuster, hasPassword,
                    serverUptime, roundTime, gameIpAndPort, punkBusterVersion, joinQueueEnabled, region,
                    closestPingSite, country, blazePlayerCount, blazeGameState)
    ...
    def test_decodeServerinfo_R17(self):
        ...
        }, BfhParser.decodeServerinfo(self.get_test_data()))
        ...
        self.assertDictEqual({
            ...
            'blazePlayerCount': '0',
            'blazeGameState': 'IN_GAME'
        }, BfhParser.decodeServerinfo(self.get_test_data(isRanked='false')))
        ...
        self.assertDictEqual({
            ...
            'blazePlayerCount': '0',
            'blazeGameState': 'IN_GAME'
        }, BfhParser.decodeServerinfo(self.get_test_data(hasPunkbuster='false')))
        ...
        self.assertDictEqual({
            ...
            'blazePlayerCount': '0',
            'blazeGameState': 'IN_GAME'
        }, BfhParser.decodeServerinfo(self.get_test_data(gamemode='SquadDeathMatch0',
                                                         numTeams='4',
                                                         team1score='0',
                                                         team2score='1',
                                                         team3score='23',
...
class Test_bfh_maps(BFHTestCase):
    ...
    def test_getMapsSoundingLike(self):
        ...
        self.assertEqual(['operation locker', 'operation whiteout', 'operation mortar'],
    ...
    def test_getGamemodeSoundingLike(self):
        self.assertEqual('ConquestSmall0', self.parser.getGamemodeSoundingLike('MP_Siege', 'ConquestSmall0'),
                         'ConquestSmall0')
        self.assertEqual('ConquestSmall0', self.parser.getGamemodeSoundingLike('MP_Siege', 'Conquest'), 'Conquest')
        self.assertListEqual(['Squad Deathmatch', 'Team Deathmatch'],
                             self.parser.getGamemodeSoundingLike('MP_Siege', 'Deathmatch'), 'Deathmatch')
        ...
        self.assertEqual('TeamDeathMatch0', self.parser.getGamemodeSoundingLike('MP_Siege', 'teamdeathmatch'),
                         'teamdeathmatch')
        self.assertEqual('TeamDeathMatch0', self.parser.getGamemodeSoundingLike('MP_Siege', 'team death match'),
                         'team death match')
        ...
        self.assertEqual('Obliteration', self.parser.getGamemodeSoundingLike('MP_Siege', 'obliteration'),
                         'obliteration')
