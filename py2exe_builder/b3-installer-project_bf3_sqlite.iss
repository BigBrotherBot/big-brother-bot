...
WizardImageFile=bf3_sqlite\WizB3Image.bmp
...
Source: "bf3_sqlite\extplugins\*"; DestDir: "{app}\extplugins"; Flags: recursesubdirs
Source: "..\..\dist_py2exe\conf\*"; DestDir: "{app}\conf"; Flags: recursesubdirs
Source: "bf3_sqlite\conf\*"; DestDir: {app}\conf; Flags: recursesubdirs; 
Source: "b3.ico"; DestDir: "{app}"
Source: "b3-plugins-icon.ico"; DestDir: "{app}"
Source: "bf3_sqlite\sed.exe"; DestDir: "{tmp}"; Flags: dontcopy
Source: "bf3_sqlite\makeB3DotXml.bat"; DestDir: "{tmp}"; Flags: dontcopy
Source: "bf3_sqlite\frostbite_server_info.exe"; DestDir: "{tmp}"; Flags: dontcopy
Source: "bf3_sqlite\frostbite_server_info.bat"; DestDir: "{tmp}"; Flags: dontcopy
Source: "bf3_sqlite\template_b3.xml"; DestDir: "{tmp}"; Flags: dontcopy
