...
AppVerName=BigBrotherBot 1.2.2b (Courgette dev build 2 30/12/2009)
...
DefaultDirName={pf}\BigBrotherBot_1.2.2b-courgette-20091230.1
DefaultGroupName=BigBrotherBot
LicenseFile=gpl-2.0.txt
OutputBaseFilename=BigBrotherBot-1.2.2b-courgette-20091230.1-win32-standalone
