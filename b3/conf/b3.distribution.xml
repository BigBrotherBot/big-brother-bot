...
<!-- 
 ...
 -->
	...
	<settings name="server">
		...
		-->
		<!-- If you are running a server with a remote log file for cod7, or using ftp, sftp or http to access it then you can specify the name and location of the local log file that is created.
		     If you do not specify a name, the log will be created based on the Public IP and Port of your server. You can also select if you want to start a new log file each time, or append to the old one
		-->
		<!--<set name="local_game_log">games_mp.log</set>-->
		<!--<set name="log_append">1</set>-->
