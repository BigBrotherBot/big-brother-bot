...
#
# 0.1
# Dwarfer, Inital build with basic connection tested, ported direct from the BF3 Parser
# all inital work done by courgette
...
GAME_MODES_BY_MAP_ID = {
    "MP_Abandoned": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
	"MP_Damage": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
	"MP_Flooded": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
	"MP_Journey": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
	"MP_Naval": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
	"MP_Prison": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
	"MP_Resort": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
	"MP_Siege": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
	"MP_TheDish": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
	"MP_Tremors": ("ConquestLarge0", "ConquestSmall0", "Domination0", "Elimination0", "Obliteration", "SquadDeathMatch0", "TeamDeathMatch0"),
}
...
class Bf4Parser(AbstractParser):
    ...
    def checkVersion(self):
        ...
        if int(version[1]) < BF4_REQUIRED_VERSION:
            raise Exception("the BF3 parser can only work with Battlefield 4 server version %s and above. You are tr"
